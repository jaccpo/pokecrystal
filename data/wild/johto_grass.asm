...
;db 2 percent, 2 percent, 2 percent - Rates (higher: encounters more often)
...
JohtoGrassWildMons:
	...
	def_grass_wildmons ROUTE_30_SMALL_CAVE
	db 4 percent, 4 percent, 4 percent
	; morn
	db 17, ZUBAT ; WOOBAT
	db 17, HOUNDOUR ; NICKIT
	db 17, ZUBAT
	db 18, HOUNDOUR
	db 19, HOUNDOUR
	db 19, ZUBAT
	...
	def_grass_wildmons ROUTE_30_SMALL_CAVE_1
	db 4 percent, 4 percent, 4 percent
	; morn
	db 18, ZUBAT
	db 18, HOUNDOUR
	db 19, HOUNDOUR
	db 19, ZUBAT
	db 17, BEEDRILL ; MAWILE 6%
	db 20, HOUNDOUR
	db 19, BEEDRILL ; MAWILE 6%
	; day
	db 18, ZUBAT
	db 18, HOUNDOUR
	db 19, HOUNDOUR
