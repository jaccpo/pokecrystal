...
MonMenuIcons:
	...
	db ICON_MOTH        ; DUSTOX
	db ICON_MONSTER     ; MAWILE (was BEEDRILL)
	db ICON_BIRD        ; PIDGEY
	...
	db ICON_FIGHTER     ; MIENFOO - was MACHOP
	db ICON_FIGHTER     ; MIENSHAO - was MACHOKE
	db ICON_FIGHTER     ; MACHAMP
	db ICON_ODDISH      ; BELLSPROUT
	db ICON_ODDISH      ; WEEPINBELL
	db ICON_ODDISH      ; VICTREEBEL
	db ICON_ODDISH      ; Alt form belllsprount - was TENTACOOL
	db ICON_MONSTER     ; Lickitung evo - was TENTACRUEL
	db ICON_ODDISH      ; GEODUDE (Cherubi)
	db ICON_ODDISH      ; GRAVELER (Cherrim)
	db ICON_ODDISH      ; GOLEM (Petrothorn)
	...
	db ICON_BLOB        ; GULPIN (was GRIMER)
	db ICON_BLOB        ; SWALOT (was MUK)
	db ICON_MONSTER     ; BERGMITE
	db ICON_MONSTER     ; AVALUGG
	db ICON_GHOST       ; GASTLY
	db ICON_GHOST       ; HAUNTER
	db ICON_GHOST       ; GENGAR
	db ICON_SHELL       ; TURBAN, placeholder name
	db ICON_HUMANSHAPE  ; Spoink (was DROWZEE)
	db ICON_HUMANSHAPE  ; Grumpig (was HYPNO)
	db ICON_SHELL       ; KRABBY
	db ICON_SHELL       ; KINGLER
	db ICON_VOLTORB     ; VOLTORB
	db ICON_VOLTORB     ; ELECTRODE
	db ICON_VOLTORB     ; Chingling - was EXEGGCUTE
	...
	db ICON_FOX         ; BETAWATER1
	db ICON_FOX         ; BETAWATER2
	db ICON_LAPRAS      ; BETAWATER3
	db ICON_FOX         ; SENTRET
	db ICON_FOX         ; FURRET
	...
	db ICON_FISH        ; Skrelp, was MARILL 
	...
	db ICON_FISH        ; QUAGSIRE (Clodsire)
	db ICON_FOX         ; ESPEON
	db ICON_FOX         ; UMBREON
	...
	db ICON_UNOWN       ; UNOWN
	db ICON_MONSTER     ; WOBBUFFET (Gargoyle)
	db ICON_EQUINE      ; GIRAFARIG
	db ICON_EQUINE      ; FARIGIRAF
	db ICON_ODDISH      ; plantrock (was Forretress)
	db ICON_SERPENT     ; DUNSPARCE BETA
	db ICON_FOX         ; SOCKFOX 
	...
	db ICON_BUG         ; SCIZOR
	db ICON_BUG         ; SHUCKLE - Shucklebite
	...
	db ICON_EQUINE      ; SWINUB - Amaura
	db ICON_EQUINE      ; PILOSWINE - Aurorus
	...
	db ICON_MONSTER     ; GORK (SMEARGLE)
	db ICON_SHELL       ; Cursola (TYROGUE)
	db ICON_FIGHTER     ; HITMONTOP
	db ICON_HUMANSHAPE  ; SMOOCHUM
	db ICON_HUMANSHAPE  ; ELEKID
	db ICON_LAPRAS      ; SEARLION (was Magby)
	db ICON_EQUINE      ; MILTANK
	db ICON_SERPENT     ; DRAMPA (was Blissey)
	db ICON_FOX         ; RAIKOU
	db ICON_FOX         ; ENTEI
	db ICON_FOX         ; SUICUNE
