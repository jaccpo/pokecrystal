...
; ANIM_OBJ_SMALL_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; changed to blue since it's only used for Icicle Crash
; ANIM_OBJ_STRENGTH
...
; ANIM_OBJ_MEAN_LOOK
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_AD, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW, ANIM_GFX_PSYCHIC
