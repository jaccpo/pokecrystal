; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_BURN ; was EFFECT_UNUSED_4E
	...
	const EFFECT_CURSE
	const EFFECT_SPEEDUPHIT ; was EFFECT_UNUSED_6E
	...
	const EFFECT_QUIVERDANCE ; Was unused 82
	const EFFECT_BULKUP ; Was unused 83, copy of Normal Hit
	...
	const EFFECT_FLAREBLITZ
	const EFFECT_CALMMIND
	const EFFECT_DRAGONDANCE
	const EFFECT_MEDITATE
	const EFFECT_COIL
	const EFFECT_TOXICHIT
	const EFFECT_GULPUP
