...
; Johto hidden items
	...
	const EVENT_ROUTE_30_SMALL_CAVE_HIDDEN_ETHER
	const EVENT_ROUTE_30_SMALL_CAVE_1_HIDDEN_MAX_REVIVE
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_SANDRA
; ExecutiveF
...
; Unused: next 116 events
	...
	const_next 1599 ; Was 1600. Decreasing by 1 allowed me to add an event constant. In order maybe? Not sure.
...
; Johto itemballs
	...
	const EVENT_NEW_BARK_TOWN_TM_HORN_DRILL
	...
	const EVENT_ROUTE_30_SMALL_CAVE_1_PP_UP
	const EVENT_ROUTE_30_SMALL_CAVE_1_NUGGET
	const EVENT_ROUTE_30_SMALL_CAVE_1_TM_HORN_ATTACK
